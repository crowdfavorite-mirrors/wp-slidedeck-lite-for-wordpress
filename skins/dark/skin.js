(function($){
	SlideDeckSkin['dark'] = function(slidedeck){
    ...
    $(document).ready(function(){
        $('.skin-dark .slidedeck').each(function(){
            if(typeof($.data(this, 'skin-dark')) == 'undefined'){
                $.data(this, 'skin-dark', new SlideDeckSkin['dark'](this));
            }
        });
    });
})(jQuery);