(function($){
	SlideDeckSkin['image_caption_top'] = function(slidedeck){
        ...
        function imgLoaded(el, thisSlide){
            if($.data(el, 'image_caption_top-sized') == true){
                return false;
            }
            ...
            if(pic_real_width > 0 && pic_real_height > 0){
                $.data(el, 'image_caption_top-sized', true);
            }
        }
    ...
    $(document).ready(function(){
        $('.skin-image_caption_top .slidedeck').each(function(){
            if(typeof($.data(this, 'skin-image_caption_top')) == 'undefined'){
                $.data(this, 'skin-image_caption_top', new SlideDeckSkin['image_caption_top'](this));
            }
        });
    });
})(jQuery);